                                            ...
                                            <div class="card-body p-4 p-lg-5 text-black">
                                                ...
                                                <form action="{{ route('add.blog') }}" method="post">
                                                    ...
                                                    <div class="modal-header justify-content-center">
                                                        ...
                                                        <span class="h2 fw-bold mb-0">Add Blog</span>
                                                    </div>
                                                    ...
                                                    <div class="form-outline mb-4">
                                                        <h5>Content</h5>
                                                        <textarea name="content" class="form-control form-control-lg" style="height: 300px; text-align: left; padding-top: 10px;" required></textarea>
                                                    </div>
