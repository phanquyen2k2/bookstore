                                    ...
                                    <div class="row g-0 justify-content-center">
                                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                            <div class="card-body p-4 p-lg-5 text-black">
                                                ...
                                                <form action="{{ route('update.blog',$blogs->id) }}" method="post">
                                                    @csrf
                                                    <div class="modal-header justify-content-center">
                                                        <img src="https://cdn-icons-png.flaticon.com/512/3531/3531989.png" alt="Logo">
                                                        <span class="h2 fw-bold mb-0">Update Blog</span>
                                                    </div>
                                                    <div class="form-outline mb-4">
                                                        <h5>Title</h5>
                                                        <input type="text" name="title" value="{{ $blogs->title }}" class="form-control form-control-lg" required>
                                                    </div>
                                                    <div class="form-outline mb-4">
                                                        <h5>Content</h5>
                                                        <textarea name="content" class="form-control form-control-lg" style="height: 300px; text-align: left; padding-top: 10px;" required>
                                                            {{ $blogs->content }}
                                                        </textarea>
                                                    </div>
