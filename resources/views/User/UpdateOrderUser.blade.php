                                ...
                                <div class="row g-0 justify-content-center">
                                    <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                        <div class="card-body p-4 p-lg-5 text-black">
                                            <a href="{{ route('orderlist.user') }}" class="btn-close" aria-label="Close"></a>
                                            <form action="{{ route('order-user.update', $order->id) }}" method="post">
                                                @csrf
                                                <div class="modal-header justify-content-center">
                                                    <img src="https://cdn-icons-png.flaticon.com/512/3531/3531989.png" alt="Logo">
                                                    <span class="h2 fw-bold mb-0">Edit Order User</span>
                                                </div>
                                                ...
                                                <div class="form-outline mb-4">
                                                    <h5>Email</h5>
                                                    <input type="email" name="email" class="form-control form-control-lg" value="{{ $order->email }}"  required readonly>
                                                </div>
                                                <div class="form-outline mb-4">
                                                    <h5>Address</h5>
                                                ...
                                                <div class="form-outline mb-4">
                                                    ...
                                                    <input type="number" name="total_quantity" class="form-control form-control-lg" value="{{ $order->total_quantity }}"  required readonly>
                                                </div>
                                                <div class="form-outline mb-4">
                                                    <h5>Total Price</h5>
                                                    <input type="text" id="total_price" name="total_price" class="form-control form-control-lg" value="{{ number_format($order->total_price, 0, '', '') }}" required readonly>
                                                </div>                                                
                                                <div class="form-outline mb-4">
                                                    <h5>Payment Method</h5>
                                                    <input type="text" name="payment_method" class="form-control form-control-lg" value="{{ $order->payment_method }}" required readonly>
                                                </div>
                                                <div class="form-outline mb-4">
                                                    <h5>Status</h5>
                                                    <input type="text" name="status" class="form-control form-control-lg" value="{{ $order->status }}" required readonly>
                                                </div>
