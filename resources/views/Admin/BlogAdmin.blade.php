...
<body>
    ...
    <main class="table">
        <section class="table__header">
            <h2>Blog List</h2>
            <a  class="btn btn-primary" href="{{ route('add-blog.form') }}">Add Products</a>
        </section>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $blog ->title }}</td>
                        <td>{{ $blog ->content}}</td>
                        <td><a href="{{ route("update-blog.form", $blog->id) }}"><i class='bx bx-message-square-edit icon'></i></td>
                        <td><a href="{{ route("delete.blog", $blog->id) }}"><i class='bx bx-trash icon'></i></a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
