                                ...
                                <div class="row g-0 justify-content-center">
                                    <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                        <div class="card-body p-4 p-lg-5 text-black">
                                            <a href="{{ route("user-list")}}" class="btn-close" aria-label="Close"></a>
                                            <form action="{{ route('home.edit-user', $user->id) }}" method="post">
                                                @csrf
                                                <div class="modal-header justify-content-center">
                                                    <img src="https://cdn-icons-png.flaticon.com/512/3531/3531989.png" alt="Logo">
                                                    <span class="h2 fw-bold mb-0">Edit User</span>
                                                </div>
                                                ...
                                                @endif
                                                <div class="pt-1 mb-4">
                                                    <input type="submit" value="Update User" class="btn btn-dark btn-lg btn-block w-100">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
